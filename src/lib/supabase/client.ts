...
const supabaseAnonKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || "temp-anon-key-placeholder";

// 임시 처리: 환경변수가 없어도 진행 (실제 배포 시 제거 필요)
if (!process.env.NEXT_PUBLIC_SUPABASE_URL || supabaseUrl === "https://temp-project.supabase.co") {
  console.warn(
